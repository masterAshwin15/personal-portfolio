...
export const About = () => {
  ...
  const items = [
    ...
    },
    {
      ...
      description:
        "I have various hobbies that I love to do in my spare time. One of my biggest hobbies is sports and fitness, both watching and playing sports. Sports that I am highly interested in are Soccer, Basketball, and MMA. I first started playing soccer at the age of 6, joined rep league at the age of 9, and also completed my refereeing license. My interest in sports has made me develop myself to be a huge team player, become adaptable to any situation, take constructive critism in a positive manner, and most importantly of all, makes me perform efficiently under pressure.\n\n"
        + "Another hobbie that I have that I would also associate as a part of my personality is that I love learning new things. My extensive curiosity allows me to seek interest in things that I don't already know, and provokes me to learn more about that topic that I don't know about. Through my experiences of learning many new things is a key factor as to why I am a very fast hands on learner. Recently I have been into learning all as many flags of countries, and as of now I am able to name 165 of 195 possible country flags.\n\n"
        + "Music is another huge interest that I have. A list of instruments I know how to play are piano/keyboard, trumpet, and alto saxaphone. I listen to various styles of music in both the English and Tamil language, and I associate listening music as one of my favourite past time hobbies.\n\n",
      img: soccer
    }
